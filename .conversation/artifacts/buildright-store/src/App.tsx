...
import heroToolsImage from "../attached_assets/generated_images/buildright-hero-tools.png";
...
function BrandMark() {
  return (
    ...
    >
      <div
        className="relative flex h-11 w-11 items-center justify-center bg-[#07518b] text-white"
        style={{
          clipPath: "polygon(50% 0, 100% 31%, 100% 100%, 0 100%, 0 31%)",
        }}
      >
        <Home size={23} strokeWidth={2.8} />
      </div>
      <div className="leading-none">
        <div className="font-display text-[21px] font-bold tracking-[-.04em] text-[#07518b]">
          Build<span className="text-[#f23868]">Right</span>
        </div>
        <div className="mt-1 text-[9px] font-bold tracking-[.26em] text-slate-500">
          HARDWARE STORE
        </div>
      </div>
    </Link>
      ...
      <div className="br-topbar">
        <div className="br-container flex h-7 items-center justify-between">
          <span className="font-semibold tracking-wide">
            Trusted Tools. Stronger Tomorrows.
          </span>
      ...
      <div className="br-container grid min-h-[375px] items-center gap-8 py-10 md:grid-cols-[1fr_1.05fr] md:py-0">
        <div className="br-fade max-w-[510px]">
          ...
          <h1 className="font-display text-4xl font-bold leading-[1.06] tracking-[-.045em] sm:text-5xl lg:text-[58px]">
            Everything You Need
            <br />
            <span className="text-[#6dd6ff]">To Build Better</span>
          </h1>
          <p className="mt-4 max-w-[430px] text-base leading-7 text-blue-50">
            Quality tools, trusted brands, and expert advice for every project —
            big or small.
          </p>
          <Link
            href="/products"
  ...
  return (
    <footer className="bg-[#082e4d] pt-10 text-blue-100">
      <div className="br-container grid gap-8 pb-9 sm:grid-cols-2 md:grid-cols-4">
        <div>
          <BrandMark />
          <p className="mt-4 max-w-[250px] text-xs leading-6 text-blue-200">
            Dependable products, clear pricing, and practical advice for every
            Indian project.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="space-y-2 text-xs">
            <span className="block">Track your order</span>
      ...
      <div className="border-t border-white/10 py-4 text-center text-[11px] text-blue-300">
        © 2025 BuildRight Hardware Store · Built for better work
      </div>
    </footer>
  );
}
    ...
    <>
      ...
      <section className="bg-[#f0f6fa] py-8 text-center">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Talk to a BuildRight expert before you buy.
        </p>
        <button
      ...
      <main className="br-container flex min-h-[60vh] items-center justify-center py-12">
        <div className="max-w-md text-center">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Thanks for choosing BuildRight. Your order BR-24081 is confirmed and
            our team will begin preparing it shortly.
          </p>
          <Link
            href="/"
        ...
        <div className="mt-7 grid gap-7 lg:grid-cols-[1fr_380px]">
          ...
          <aside className="h-fit rounded-lg border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-center text-[11px] text-slate-500">
              Your details are protected with BuildRight's secure checkout.
            </p>
          </aside>
        </div>
      )}
